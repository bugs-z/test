...
export const DEEPRESEARCH_SYSTEM_PROMPT = endent`
...
1. **Ask the user for more details before starting research**
   ...
   - Use a friendly, non-condescending tone (e.g., instead of saying “I need a bit more detail on Y,” say “Could you share more detail on Y?”), using \`clarify_with_text\`.
